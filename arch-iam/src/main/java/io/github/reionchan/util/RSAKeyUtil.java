...
public final class RSAKeyUtil {
    ...
    public static String getPublicKeyAsX509Pem(RSAPublicKey publicKey) {
        ...
        String pubBaseStr = Base64.getEncoder().encodeToString(publicKey.getEncoded());
    ...
    public static String getPrivateKeyAsPKCS8Pem(RSAPrivateKey privateKey) {
        ...
        String pubBaseStr = Base64.getEncoder().encodeToString(privateKey.getEncoded());
     ...
     * alias "ArchKey"
     * password "123456"
     * keystore "arch_keystore.jks"
     */
    public static KeyPair loadFromKeyStoreFile(String jksPath, String password, String alias) {
        KeyStoreKeyFactory kf = new KeyStoreKeyFactory(new ClassPathResource(jksPath), password.toCharArray());
        return kf.getKeyPair(alias);
    }
}
