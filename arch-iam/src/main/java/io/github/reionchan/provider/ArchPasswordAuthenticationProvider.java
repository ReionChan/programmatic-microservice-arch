 ...
 * @date 2024-06-03
 **/
public class ArchPasswordAuthenticationProvider implements AuthenticationProvider {
     ...
     * @since 0.2.3
     */
    public ArchPasswordAuthenticationProvider(AuthenticationManager authenticationManager,
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        ArchAuthPasswordAuthenticationToken resouceOwnerPasswordAuthentication = (ArchAuthPasswordAuthenticationToken) authentication;
        ...
        if (isEmpty(registeredClient.getAuthorizationGrantTypes())
    ...
    public boolean supports(Class<?> authentication) {
        boolean supports = ArchAuthPasswordAuthenticationToken.class.isAssignableFrom(authentication);
        LOGGER.debug("supports authentication=" + authentication + " returning " + supports);
        return supports;
    }

    private Authentication getUsernamePasswordAuthentication(ArchAuthPasswordAuthenticationToken resouceOwnerPasswordAuthentication) {
