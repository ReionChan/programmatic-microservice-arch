 ...
 * @date 2024-06-03
 **/
public class ArchAuthPasswordAuthenticationToken extends AbstractAuthenticationToken {
    ...
    public ArchAuthPasswordAuthenticationToken(AuthorizationGrantType authorizationGrantType,
